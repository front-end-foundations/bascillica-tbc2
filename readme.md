...
```js
import { apiData } from "./modules/recipes.js";

var region = document.querySelector("#region");
region.innerText = apiData[0].regions[2];
var instructions = document.querySelector("[itemprop='recipeInstructions']");

console.log(apiData[0].directions);

apiData[0].directions.map((direction) => {
